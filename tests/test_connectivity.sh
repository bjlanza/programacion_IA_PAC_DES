...
echo ""
echo "── HTTP / Web UIs ──────────────────────────────────────"
check_http "Redpanda Console" "http://localhost:18080/"
check_http "Flink UI"         "http://localhost:18081/"
check_http "InfluxDB UI"      "http://localhost:18086/health"
check_http "MinIO Console"    "http://localhost:19001/"
check_http "Grafana"          "http://localhost:13000/api/health"

echo ""
echo "── TCP / Protocolos ────────────────────────────────────"
check_tcp "MQTT Broker"    "localhost" "11883"
check_tcp "Redpanda Kafka" "localhost" "19092"
check_tcp "MinIO S3 API"   "localhost" "19000"
